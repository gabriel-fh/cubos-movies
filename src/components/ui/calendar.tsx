  ...
  return (
    <div className="w-full">
      <Select onValueChange={handleValueChange} defaultValue={defaultValue}>
        <SelectTrigger className="w-full h-10 mt-2 bg-mauve2 rounded-sm focus:outline-none focus:ring-1 focus:ring-purple9 focus:caret-purple9">
          <SelectValue className="!text-white" placeholder={caption} />
        </SelectTrigger>
        <SelectContent>
          <SelectGroup style={{
          }} className="absolute -top-[100px] left-0 rounded-sm  max-h-[100px] w-[100px] p-2 bg-red-500 overflow-y-auto">
            {content.map(item => {
              const { props } = item
  ...
  return (
    <DayPicker
      ...
      classNames={{
        ...
        day_selected:
          '!bg-purple9 !text-white hover:bg-primary hover:text-primary-foreground focus:bg-primary focus:text-primary-foreground',
