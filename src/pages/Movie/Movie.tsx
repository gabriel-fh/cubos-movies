  ...
  return (
    data && (
      <main className={"relative p-4 flex flex-wrap gap-4"}>
        ...
        <section className="relative md:py-4 md:px-2 lg:px-4 xl:p-8 flex flex-wrap gap-4">
          <div
            className="hidden md:block absolute -z-[1] top-0 left-0 w-full h-full bg-no-repeat bg-cover bg-center
            before:w-full before:h-full before:absolute before:top-0 before:left-0 before:bg-gradient-to-r before:from-mauve1 before:to-mauve1/50 before:via-mauve1/70 rounded-sm"
            style={{ backgroundImage: `url(${IMG_BASE_URL + data.backdrop_path})` }}
          />
          <figure className="aspect-[2/3] md:w-[30%]">
